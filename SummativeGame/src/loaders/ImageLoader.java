...
public class ImageLoader {
     ...
     *
     * @param file the directory of the image to be loaded, res/textures
     * directory is assumed, file format (i.e. .jpeg) must not be included
     * @param format the type of format the image uses, identified by a static
     * call to the ImageLoader class (ex. ImageLoader.IMAGE_JPG_FORMAT_ID)
